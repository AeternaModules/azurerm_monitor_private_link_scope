output "monitor_private_link_scopes_id" {
  ...
  value       = { for k, v in azurerm_monitor_private_link_scope.monitor_private_link_scopes : k => v.id if v.id != null && length(v.id) > 0 }
}
output "monitor_private_link_scopes_ingestion_access_mode" {
  ...
  value       = { for k, v in azurerm_monitor_private_link_scope.monitor_private_link_scopes : k => v.ingestion_access_mode if v.ingestion_access_mode != null && length(v.ingestion_access_mode) > 0 }
}
output "monitor_private_link_scopes_name" {
  ...
  value       = { for k, v in azurerm_monitor_private_link_scope.monitor_private_link_scopes : k => v.name if v.name != null && length(v.name) > 0 }
}
output "monitor_private_link_scopes_query_access_mode" {
  ...
  value       = { for k, v in azurerm_monitor_private_link_scope.monitor_private_link_scopes : k => v.query_access_mode if v.query_access_mode != null && length(v.query_access_mode) > 0 }
}
output "monitor_private_link_scopes_resource_group_name" {
  ...
  value       = { for k, v in azurerm_monitor_private_link_scope.monitor_private_link_scopes : k => v.resource_group_name if v.resource_group_name != null && length(v.resource_group_name) > 0 }
}
output "monitor_private_link_scopes_tags" {
  ...
  value       = { for k, v in azurerm_monitor_private_link_scope.monitor_private_link_scopes : k => v.tags if v.tags != null && length(v.tags) > 0 }
}
